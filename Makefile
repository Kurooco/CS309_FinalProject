...
parallel:
	g++ -c parallelmain.cpp -I"C:\Users\DJsul\OneDrive\Documents\libraries\SFML-2.5.1\include" -DSFML_STATIC -fopenmp

link_parallel:
	g++ parallelmain.o -L"C:\Users\DJsul\OneDrive\Documents\libraries\SFML-2.5.1\lib" -lsfml-graphics -lsfml-audio -lsfml-window -lsfml-system -lopengl32 -lfreetype -lwinmm -lgdi32 -openal32 -fopenmp -o Main
